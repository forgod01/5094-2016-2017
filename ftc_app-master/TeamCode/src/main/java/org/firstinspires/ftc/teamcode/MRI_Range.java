...
@TeleOp(name = "Range", group = "Iterative Opmode")
public class MRI_Range extends OpMode {

    byte[] range1Cache; //The read will return an array of bytes. They are stored in this variable

    I2cAddr RANGE1ADDRESS = new I2cAddr(0x30); //Default I2C address for MR Range (7-bit)
    ...
    @Override
    public void init() {
        RANGE1 = hardwareMap.i2cDevice.get("front");
